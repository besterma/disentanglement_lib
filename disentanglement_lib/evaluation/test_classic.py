...
batch = '5000'
output_dir="/home/disentanglement/Python/disentanglement_lib_francesco/models/500/model/results_mig_bs"+batch
...
evaluate_with_gin(model_dir, 
        output_dir, 
        overwrite=True, 
        gin_bindings=gin_bindings)

output_dir="/home/disentanglement/Python/disentanglement_lib_francesco/models/500/model/results_dci_bs"+batch
